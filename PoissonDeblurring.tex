...
\title[]{Poisson Image Deblurring} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Sek Cheong, Das Deepan} % Your name
...
\medskip
\textit{\{sucheong, ddas27\}@wisc.com} % Your email address
}
